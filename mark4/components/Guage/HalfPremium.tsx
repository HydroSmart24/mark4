    ...
    <View style={{ ...styles.container, width: size, height: size }}>
      ...
      <View
        style={{
          ...
          left: '50%',
          transform: [
            { translateX: -(adjustedSize * 0.50) },
            { translateY: -(adjustedSize * 0.50) },
          ],
        }}
      >
        <Text style={{ ...styles.valueText, fontSize: adjustedSize * 0.5 }}>{value}</Text>
        <Text style={{ ...styles.labelText, fontSize: adjustedSize * 0.25 }}>Average</Text>
      </View>
    </View>
  );
};
